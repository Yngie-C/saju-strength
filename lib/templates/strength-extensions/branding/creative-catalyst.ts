...
export const CREATIVE_CATALYST_BRANDING: BrandingMessageTemplate[] = [
  {
    ...
    linkedinHeadline: '창의적 촉매 | 집단지성을 활용해 최고의 답을 찾아요',
    elevatorPitch: '혼자보다 함께가 더 좋은 답을 만든다고 믿어요. 팀의 다양한 관점을 연결해 혁신적인 해결책을 이끌어내요.',
  ...
  },
  {
    ...
    linkedinHeadline: '창의적 촉매 | 팀의 숨겨진 창의성을 끌어내요',
    elevatorPitch: '저와 함께하면 회의가 달라져요. 모든 팀원의 아이디어를 끌어내고 연결해서 아무도 예상 못한 답을 만들어내요.',
  ...
  },
  {
    ...
    linkedinHeadline: '창의적 촉매 | 협업을 통해 혁신적 결과를 만들어요',
    elevatorPitch: '다양한 의견을 종합하고 발전시켜 더 나은 해결책을 찾아요. 팀의 창의성을 이끌어내는 것이 제 강점이에요.',
