...
export const STEADY_ACHIEVER_BRANDING: BrandingMessageTemplate[] = [
  {
    ...
    elevatorPitch: '맡은 일은 반드시 완수해요. 끈기와 책임감으로 어려운 상황에서도 흔들리지 않고 목표를 달성해요.',
  ...
  },
  {
    ...
    elevatorPitch: '남들이 포기할 때 저는 방법을 찾아요. 어떤 난관도 끈기와 집중력으로 돌파하고 반드시 결과를 만들어내요.',
  ...
  },
  {
    ...
    elevatorPitch: '하루하루 꾸준히 진전을 만들며 목표를 향해 나아가요. 책임감 있게 맡은 일을 완수해요.',
