...
export const ADAPTIVE_PIONEER_BRANDING: BrandingMessageTemplate[] = [
  {
    ...
    elevatorPitch: '변화를 두려워하지 않아요. 불확실한 환경에서 빠르게 학습하고 적응하며, 새로운 기회를 만들어내요.',
  ...
  },
  {
    ...
    elevatorPitch: '위기 상황에서 저의 진가가 발휘돼요. 빠른 적응력과 혁신적 사고로 남들이 보지 못하는 기회를 포착해요.',
  ...
  },
  {
    ...
    elevatorPitch: '새로운 환경에서 빠르게 적응하고, 혁신적인 방법을 시도해요. 변화를 성장의 기회로 만들어요.',
