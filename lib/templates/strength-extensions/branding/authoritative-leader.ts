...
export const AUTHORITATIVE_LEADER_BRANDING: BrandingMessageTemplate[] = [
  {
    ...
    elevatorPitch: '명확한 목표와 체계적 실행으로 팀을 이끌어요. 말보다 성과로 신뢰를 쌓고, 조직의 목표를 현실로 만들어요.',
  ...
  },
  {
    ...
    elevatorPitch: '저는 숫자로 이야기해요. 목표를 설정하면 반드시 달성하고, 그 과정에서 팀의 역량까지 끌어올려요.',
  ...
  },
  {
    ...
    elevatorPitch: '명확한 방향을 제시하고 팀과 함께 목표를 달성해요. 체계적인 관리와 추진력으로 결과를 만들어내요.',
