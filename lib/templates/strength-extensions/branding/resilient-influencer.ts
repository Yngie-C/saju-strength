...
export const RESILIENT_INFLUENCER_BRANDING: BrandingMessageTemplate[] = [
  {
    ...
    elevatorPitch: '위기 상황에서 침착하게 메시지를 전달하는 것이 제 역할이에요. 역경 속에서도 흔들리지 않고 사람들을 이끌어요.',
  ...
  },
  {
    ...
    elevatorPitch: '모두가 당황할 때 저는 마이크를 잡아요. 위기 상황에서 명확한 메시지로 팀을 안정시키고 방향을 제시해요.',
  ...
  },
  {
    ...
    elevatorPitch: '어려운 상황에서도 포기하지 않고 메시지를 전달해요. 회복력을 바탕으로 지속적인 영향력을 발휘해요.',
