...
export const THE_ANCHOR_BRANDING: BrandingMessageTemplate[] = [
  {
    ...
    linkedinHeadline: '신뢰의 중추 | 일관된 품질과 협업으로 조직을 지탱해요',
    elevatorPitch: '맡은 일은 반드시 약속한 품질로 완수해요. 안정적인 실행력과 협업 능력으로 팀에 신뢰를 제공해요.',
  ...
  },
  {
    ...
    elevatorPitch: '화려한 스포트라이트보다 팀의 성공을 만드는 든든한 기반이 되고 싶어요. 묵묵히 일하고, 결과로 증명해요.',
  ...
  },
  {
    ...
    linkedinHeadline: '신뢰의 중추 | 체계적 실행과 팀워크로 기여해요',
    elevatorPitch: '팀원들과 협력하여 목표를 달성해요. 안정적인 업무 처리와 신뢰 관계 구축이 제 강점이에요.',
