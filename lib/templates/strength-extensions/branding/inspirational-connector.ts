...
export const INSPIRATIONAL_CONNECTOR_BRANDING: BrandingMessageTemplate[] = [
  {
    ...
    linkedinHeadline: '공감형 리더 | 관계를 통해 팀과 조직을 하나로 만들어요',
    elevatorPitch: '사람의 마음을 이해하고 연결하는 것이 제 강점이에요. 진심 어린 소통과 협업으로 팀의 시너지를 만들어요.',
  ...
  },
  {
    ...
    linkedinHeadline: '공감형 리더 | 마음을 얻어 함께 승리해요',
    elevatorPitch: '저와 이야기하면 마음이 열려요. 진정성 있는 관계를 바탕으로 팀원들의 잠재력을 끌어내고 함께 성장해요.',
  ...
  },
  {
    ...
    linkedinHeadline: '공감형 리더 | 소통과 협업으로 성과를 만들어요',
    elevatorPitch: '팀원들과의 열린 소통을 통해 협업을 촉진해요. 관계를 기반으로 팀의 목표 달성을 이끌어요.',
